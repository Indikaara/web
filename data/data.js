      ...
      items: [
        {
          ...
          price: 2950,
          priceRange: null,
          image: ["assets/products/home-decor/vintage-crafts/vintage_tripod_fan/1.jpg"],
        ...
        },
        {
          ...
          price: 2950,
          priceRange: null,
          image: ["assets/products/home-decor/vintage-crafts/wall_hanging/bullet_motorcycle/1.jpg", "assets/products/home-decor/vintage-crafts/wall_hanging/bullet_motorcycle/2.jpg"],
        ...
        },
        {
          ...
          price: 2950,
          priceRange: null,
          image: ['assets/products/home-decor/vintage-crafts/wall_hanging/vintage_car/1.jpg'],
        ...
        },
        {
          ...
          price: 2950,
          priceRange: null,
          image: ['assets/products/home-decor/vintage-crafts/wall_hanging/cycle/1.jpg'],
        ...
        },
        {
          ...
          price: 2950,
          priceRange: null,
          image: ["assets/products/home-decor/vintage-crafts/wall_hanging/motorcycle_american/1.jpg", "assets/products/home-decor/vintage-crafts/wall_hanging/motorcycle_american/2.jpg"],
        ...
        },
        {
          ...
          price: 1600,
          priceRange: null,
          image: ["assets/products/home-decor/vintage-crafts/wall_hanging/wall_clock/1.jpg", "assets/products/home-decor/vintage-crafts/wall_hanging/wall_clock/2.jpg"],
        ...
        },
        {
          ...
          price: 1500,
          priceRange: null,
          image: ["assets/products/home-decor/vintage-crafts/wall_hanging/elephant_head/1.jpg"],
...
rawProductData.products.forEach((category) => {
  ...
  category.items.forEach((item) => {
    ...
    allProducts.push({
      ...
      dimensions: item.dimensionsAvailable
        ? item.dimensionsAvailable.join(", ")
        : "N/A",
...
export function addToEnquiryList(productId, quantity = 1) {
  ...
  if (!product || product.stock <= 0) {
    ...
    document.dispatchEvent(
      new CustomEvent("productEnquiryError", {
        detail: {
          message: "This product is out of stock or does not exist!",
  ...
  document.dispatchEvent(
    new CustomEvent("productAddedToEnquiry", {
...
export function changeQuantity(productId, change) {
  ...
  if (cartItem) {
    ...
    if (newQuantity > 0 && newQuantity <= product.stock) {
      ...
      document.dispatchEvent(
        new CustomEvent("productRemovedFromEnquiry", {
          detail: { productName: product.name },
        })
      );
      return;
    ...
    document.dispatchEvent(
      new CustomEvent("productQuantityChanged", {
        detail: {
          productId: productId,
...
export function handleEnquireNow() {
  if (cart.length === 0) {
    ...
    document.dispatchEvent(
      new CustomEvent("enquiryListEmpty", {
        detail: {
          message: "Your enquiry list is empty. Please add items to enquire.",
        },
      })
    );
    return;
  ...
  window.location.href = `mailto:your.email@example.com?subject=Enquiry from Indikaara Website&body=${encodeURIComponent(
    enquiryDetails
  )}`;

  // Dispatch a custom event for email preparation
  document.dispatchEvent(
    new CustomEvent("enquiryEmailPrepared", {
      detail: {
        message:
          "Your enquiry request is being prepared. Please send the email that opens up.",
      },
    })
  );
}
